...
grep -A 2 -E "CREATE | SET |ALTER | INDEX | 'CREATE UNIQUE' " $OUTPUT_FILE_NM > CRT_INDEX.sql &
grep -v "CREATE TRIGGER" -A 3 CRT_INDEX.sql > CRT_INDEX.sql &
